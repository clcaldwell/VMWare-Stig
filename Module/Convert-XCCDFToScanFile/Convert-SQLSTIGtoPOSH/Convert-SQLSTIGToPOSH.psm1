function New-SQLPowershellScanFiles {
    ...
    BEGIN {
        ...
        try { 
            [xml]$SQLStig = Get-Content -Path $xccdf -EA Stop
        }
        catch {
    ...
    PROCESS {
        ...
        foreach ($Group in $SQLStig.Benchmark.Group) {
...
New-SQLPowershellScanFiles -xccdf J:\STIG\U_MS_SQL_Server_2014_Instance_V1R7_STIG\U_MS_SQL_Server_2014_Instance_V1R7_Manual_STIG\U_MS_SQL_Server_2014_Instance_STIG_V1R7_Manual-xccdf.xml  -outPath J:\STIG\U_MS_SQL_Server_2014_Instance_V1R7_STIG\U_MS_SQL_Server_2014_Instance_V1R7_STIG_Scan_Files
